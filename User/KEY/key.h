...
#define BUTTONx_GPIO_CLK_ENABLE(__INDEX__)                                     \
  do {                                                                         \
    if ((__INDEX__) == 0)                                                      \
      BUTTON_KEY1_GPIO_CLK_ENABLE();                                           \
    else if ((__INDEX__) == 1)                                                 \
      BUTTON_KEY2_GPIO_CLK_ENABLE();                                           \
    else if ((__INDEX__) == 1)                                                 \
      BUTTON_KEY3_GPIO_CLK_ENABLE();                                           \
    else if ((__INDEX__) == 2)                                                 \
      BUTTON_KEY4_GPIO_CLK_ENABLE();                                           \
  } while (0)
#define BUTTONx_GPIO_CLK_DISABLE(__INDEX__)                                    \
  do {                                                                         \
    if ((__INDEX__) == 0)                                                      \
      BUTTON_KEY1_GPIO_CLK_DISABLE();                                          \
    else if ((__INDEX__) == 1)                                                 \
      BUTTON_KEY2_GPIO_CLK_DISABLE();                                          \
    else if ((__INDEX__) == 1)                                                 \
      BUTTON_KEY3_GPIO_CLK_DISABLE();                                          \
    else if ((__INDEX__) == 2)                                                 \
      BUTTON_KEY4_GPIO_CLK_DISABLE();                                          \
  } while (0)

#define KEY1                                                                   \
  HAL_GPIO_ReadPin(BUTTON_KEY1_GPIO_PORT, BUTTON_KEY1_PIN) // KEY1按键PD6
#define KEY2                                                                   \
  HAL_GPIO_ReadPin(BUTTON_KEY2_GPIO_PORT, BUTTON_KEY2_PIN) // KEY2按键PB4
#define KEY3                                                                   \
  HAL_GPIO_ReadPin(BUTTON_KEY3_GPIO_PORT, BUTTON_KEY3_PIN) // KEY3按键PB6
#define KEY4                                                                   \
  HAL_GPIO_ReadPin(BUTTON_KEY4_GPIO_PORT, BUTTON_KEY4_PIN) // KEY4按键PB9
